...
const CandidateManagement: React.FC<CandidateManagementProps> = ({
  ...
  // Group candidates by job for initial display
  useEffect(() => {
  ...
  // Filter & sort candidates for selected job whenever relevant state changes
  useEffect(() => {
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-4 mb-4 text-gray-600 text-sm">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span>{candidate.experience ?? 'N/A'} yrs exp</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Banknote className="h-4 w-4" />
                          <span>Current: {candidate.currentCTC ?? 'N/A'} LPA</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Clock className="h-4 w-4" />
                          <span>Notice: {candidate.noticePeriod ?? 'N/A'} mo</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Banknote className="h-4 w-4" />
                          <span>Expected: {candidate.expectedCTC ?? 'N/A'} LPA</span>
                        </div>
                      </div>
                        ...
                        <div className="mb-4">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {candidate.skills.map((skill, i) => (
                              <span
                                key={i}
                                className="bg-[#3e94b3] text-white px-3 py-1 rounded-full text-xs font-medium"
                              >
                                {skill}
                              </span>
                            ))}
